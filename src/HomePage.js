  ...
  render(){
    return (
      <div className="HomePage">
        <Message>
          <h1>Shreya Thammana's Honors Mini-Grant</h1>
          <h1>This summer, I recieved an Honors Mini-Grant from the Calhoun Honors College. </h1>
          <h2>
              The purpose of this Honors Mini-Grant is to allow me to work on a personal project for my academic and intellectual development. 
          ...
          <h2>I am also pursuing a Computer Science minor. 
          ...
          <h2><Link to="/python">Python</Link></h2>
          <h2>
